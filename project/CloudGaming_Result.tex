...
The way we defined the word "Strong" from this question, is whether the person would get interrupted every minute or 2 with network latency in a game. If they didn't experience network latency in short terms, then the connection was strong and if not than weak. As shown in the chart above, most people claimed that they have a strong Internet connection, while a few people claimed that they do not have a strong Internet connection. Whether they were using a wireless or wired connection, most of the respondents answered "Yes".
