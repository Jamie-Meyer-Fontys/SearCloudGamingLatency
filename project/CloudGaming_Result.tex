\section{Results}
This section shows the results of our research methods that we have used.
...
The bar-plot shows that most people make use of a wired connection when they play games, where a few people use a wireless connection with either a great range (low data rate) or short range (high data rate). Since our respondents were connected to a Software Engineering study they knew what we meant with the two wireless connection options. What was also included in this survey was the question what system the interviewee uses to play video games, the most picked option was Windows/Microsoft.
...
The way we defined the word "Strong" from this question, is whether the person would get interrupted every minute or 2 with network latency in a game. If they didn't experience network latency in short terms, then the connection was strong and if not than weak. As shown in the chart above, most people claimed that they have a strong Internet connection, while a few people claimed that they do not have a strong Internet connection. Whether they were connected to a wireless or wired connection, most of the respondents answered "Yes".
...
People had the choice to fill in how interested they are in cloud gaming. Most people have said that they are slightly interested in it.\\
In the survey, we also had questions that were about the use of cloud gaming and what the respondents thought of it, such as: For cloud gaming you pay a monthly fee between 10 and 60 euros, that allows you to stream your games from a data center and that you require a strong and stable internet connection to make the best use of cloud gaming. Most respondents had mixed thoughts about cloud gaming, which could have affected the question about the interest, having it mixed results. Half of all respondents gave it slight interest and a quarter chose to have no interest in it.
...
Just like the question about how interested people were in cloud gaming, for this question people had the choice to fill in how likely they want to give cloud gaming a try.\\
